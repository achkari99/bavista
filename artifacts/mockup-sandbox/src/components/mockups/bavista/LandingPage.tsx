    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white overflow-x-hidden font-sans selection:bg-[#D4AF37] selection:text-black">
      ...
      <nav className={\`fixed top-0 left-0 right-0 z-50 transition-all duration-300 \${isScrolled ? 'glass-panel-heavy py-4' : 'bg-transparent py-6'}\`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <a href="#" className="font-serif text-2xl tracking-wider text-[#D4AF37] font-semibold flex items-center gap-2">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 opacity-40 mix-blend-screen">
          <img src="/__mockup/images/hero-bg.png" alt="Luxury Bar" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-10">
          ...
          <h1 className="font-serif text-6xl md:text-8xl lg:text-9xl mb-6 text-gold-gradient text-glow leading-tight reveal-on-scroll" style={{ animationDelay: '0.2s' }}>
            Elevate Your Events
          </h1>
      ...
      <section id="experience" className="py-32 relative">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-20 reveal-on-scroll">
            <h2 className="font-serif text-4xl md:text-5xl mb-4"><span className="text-[#D4AF37]">The Bavista</span> Experience</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="glass-panel p-10 rounded-xl text-center group hover:-translate-y-2 transition-all duration-500 reveal-on-scroll" style={{ animationDelay: \`\${i * 0.2}s\` }}>
                ...
                <h3 className="font-serif text-2xl mb-4 text-white group-hover:text-[#D4AF37] transition-colors">{card.title}</h3>
      ...
      <section id="drinks" className="py-32 relative bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20 reveal-on-scroll">
            ...
            <h2 className="font-serif text-4xl md:text-5xl">Our Signature Collection</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={i} 
                className="glass-panel p-8 rounded-xl relative overflow-hidden group hover:scale-[1.03] transition-all duration-500 reveal-on-scroll"
                style={{ 
              ...
              >
                ...
                <h3 className="font-serif text-2xl text-[#D4AF37] mb-3 relative z-10">{drink.name}</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-[#111] border border-[#222] hover:border-[#D4AF37]/50 p-8 rounded-xl relative group transition-colors duration-500 reveal-on-scroll" style={{ animationDelay: \`\${i * 0.2}s\` }}>
                ...
                <div>
                  <h4 className="font-serif text-xl text-white">{testimonial.author}</h4>
      ...
      <section id="gallery" className="py-24 overflow-hidden relative">
        <div className="text-center mb-16 reveal-on-scroll">
          <h2 className="font-serif text-4xl md:text-5xl">Moments We've Created</h2>
        </div>
            ...
            {[...Array(2)].map((_, j) => (
              <React.Fragment key={j}>
                {[
                  ...
                  { img: '/__mockup/images/gallery-1.png', text: 'Sarah\'s Wedding' },
                  ...
                  <div key={i} className="relative w-72 md:w-96 h-64 md:h-80 rounded-xl overflow-hidden flex-shrink-0 group/item">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 translate-y-4 opacity-0 group-hover/item:translate-y-0 group-hover/item:opacity-100 transition-all duration-300">
                      <h4 className="font-serif text-xl text-white">{item.text}</h4>
                    </div>
                  </div>
                ))}
              </React.Fragment>
      ...
      <section id="book" className="py-32 relative">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 glass-panel-heavy p-10 md:p-16 rounded-2xl border border-[#D4AF37]/30 shadow-[0_0_50px_rgba(212,175,55,0.1)] reveal-on-scroll">
          <div className="text-center mb-10">
            <h2 className="font-serif text-4xl md:text-5xl mb-4 text-[#D4AF37]">Ready to Elevate Your Event?</h2>
          ...
          {isSubmitted ? (
            <div className="text-center py-16 animate-fade-in-up">
              ...
              <h3 className="font-serif text-3xl mb-2 text-white">Request Received</h3>
      ...
      <footer className="bg-black py-16 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            <a href="#" className="font-serif text-2xl tracking-wider text-[#D4AF37] font-semibold flex items-center gap-2 mb-6">
              <span className="text-3xl">✧</span>
              Mocktail by Bavista
            </a>
          ...
          <div>
            <h4 className="font-serif text-xl mb-6 text-white">Contact</h4>
